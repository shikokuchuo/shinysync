...
a collaborative checklist works well because each action (add item, toggle
checkbox, delete item) is atomic - there's no cursor position to preserve.
See the "Collaborative Checklist" vignette for details.
